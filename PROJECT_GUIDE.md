...
- The workout display behaves like application UI rather than selectable document text. Its timer uses native font glyphs, including the colon, and does not replace punctuation with drawn shapes.
